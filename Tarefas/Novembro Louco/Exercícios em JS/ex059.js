...
async function principal() {
    ...
    while (true) {
        ...
        let corOlhos = await pegarResposta("Informe a cor dos olhos (azuis, verdes ou castanhos): ").toLowerCase()
        let corCabelos = await pegarResposta("Informe a cor dos cabelos (louros, castanhos ou pretos): ").toLowerCase()
        ...
        if (corOlhos === 'verdes' && corCabelos === 'louros') {
            qtdVerdeLouros++
        }
    }
